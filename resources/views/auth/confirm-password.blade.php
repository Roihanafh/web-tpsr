...
<body>
    <main class="auth-card">
        <section class="auth-panel">
            ...
            <p>Masukkan password Anda untuk melanjutkan ke area aman aplikasi.</p>
            ...
            <form method="POST" action="{{ route('password.confirm') }}">
                ...
                <button class="auth-button" type="submit">Konfirmasi</button>
            </form>
        </section>

        <section class="auth-panel brand-panel">
            <h1>Area Aman</h1>
            <p>Konfirmasi ini membantu menjaga akses akun tetap terlindungi.</p>
        </section>
    </main>
</body>
</html>
